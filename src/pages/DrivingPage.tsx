...
const DrivingPage: React.FC = () => {
  ...
  const { driving, rentalCars, days, tripCode, isAdmin, hotels, flights } = useTripContext();
  ...
  async function handleAutoplan() {
    ...
    try {
      const count = await autoGenerateDrivingRoutes(tripCode, hotels, flights, driving);
      alert(count > 0
