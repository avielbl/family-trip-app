...
const GREECE_SUGGESTIONS: DaySuggestion[] = [
  // Day 0 — March 24: Arrival + Drive to Ioannina
  {
    ...
    evening: ['Arrive at Selin Luxury Residences, Ioannina', 'First walk around Ioannina lake promenade', 'Dinner at a lakeside taverna'],
    eveningHe: ['הגעה ל-Selin Luxury Residences, יואנינה', 'טיול ראשון לאורך טיילת האגם', 'ארוחת ערב בטברנה לצד האגם'],
  ...
  // Day 4 — March 28: Tsoumerka — Kipina Monastery + Pramenti
  {
    ...
    evening: ['Scenic drive back to Ioannina', 'Relaxed dinner — last night at Selin Luxury Residences'],
    eveningHe: ['נסיעה ציורית חזרה ליואנינה', 'ארוחת ערב נינוחה – הלילה האחרון ב-Selin Luxury Residences'],
  ...
  // Day 5 — March 29: Drive to Palaios Agios Athanasios
  {
    ...
    morning: ['Checkout from Selin Luxury Residences', 'Final Ioannina morning walk around the castle', 'Pack up and head north on Via Egnatia'],
    morningHe: ['צ\'ק-אאוט מ-Selin Luxury Residences', 'טיול בוקר אחרון ביואנינה סביב המצודה', 'ארוז ויצא צפונה על כביש הגנאטיה'],
    afternoon: ['Scenic mountain drive through Florina region', 'Arrive at Palaios Agios Athanasios', 'Check in to boutique guesthouse'],
